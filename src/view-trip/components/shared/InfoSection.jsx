    ...
    <div className="space-y-6">
        ...
        <div className="relative h-[400px] md:h-[480px]">
          ...
          <div className="absolute inset-0 flex flex-col justify-end p-6 md:p-8">
            ...
            <div className="inline-flex items-center gap-2 mb-4 w-fit">
              <div className="flex items-center gap-2 bg-white/95 dark:bg-slate-900/95 backdrop-blur-md 
            ...
            <p className="text-lg md:text-xl text-white/95 font-medium drop-shadow-lg mb-6 max-w-2xl">
              Your personalized {trip?.userSelection?.duration}-day adventure awaits
            </p>

            {/* Quick Features */}
            <div className="flex flex-wrap gap-2">
              <Badge className="bg-white/95 dark:bg-slate-900/95 backdrop-blur-md 
      ...
      <div className="grid md:grid-cols-3 gap-4">
        ...
        <div className="bg-gradient-to-br from-emerald-50 to-green-50 
                     ...
                     hover:shadow-lg transition-all duration-300">
          <div className="flex items-center gap-3 mb-3">
            <div className="w-10 h-10 bg-emerald-500 dark:bg-emerald-600 rounded-lg 
                         flex items-center justify-center shadow-md">
          ...
          <p className="text-emerald-800 dark:text-emerald-300/90 text-sm leading-relaxed">
            Maximized value with strategic spending allocation across activities, 
            accommodations, and travel based on your budget.
          </p>
        </div>
        ...
        <div className="bg-gradient-to-br from-amber-50 to-orange-50 
                     ...
                     hover:shadow-lg transition-all duration-300">
          <div className="flex items-center gap-3 mb-3">
            <div className="w-10 h-10 bg-amber-500 dark:bg-amber-600 rounded-lg 
                         flex items-center justify-center shadow-md">
      ...
      {trip?.userSelection?.specificRequests && (
        <div className="bg-gradient-to-br from-purple-50 to-pink-50 
          ...
          <div className="flex items-start gap-4">
            <div className="w-12 h-12 bg-purple-500 dark:bg-purple-600 rounded-xl 
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-purple-700 dark:text-purple-400 text-xs mt-3 
      ...
      <div className="bg-white dark:bg-slate-900 rounded-xl p-6 border-2 
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="flex items-center gap-3 p-3 rounded-lg 
            ...
            <div className="w-8 h-8 bg-emerald-500 dark:bg-emerald-600 rounded-full 
          ...
          <div className="flex items-center gap-3 p-3 rounded-lg 
            ...
            <div className="w-8 h-8 bg-blue-500 dark:bg-blue-600 rounded-full 
                         flex items-center justify-center flex-shrink-0">
              <span className="text-white text-lg">✓</span>
            </div>
            <div className="flex-1 min-w-0">
          ...
          {trip?.hasRealFlights ? (
            <div className="flex items-center gap-3 p-3 rounded-lg 
              ...
              <div className="w-8 h-8 bg-sky-500 dark:bg-sky-600 rounded-full 
                           flex items-center justify-center flex-shrink-0">
                <span className="text-white text-lg">✓</span>
              </div>
              <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-3 p-3 rounded-lg 
            ...
            <div className="w-8 h-8 bg-purple-500 dark:bg-purple-600 rounded-full 
                         flex items-center justify-center flex-shrink-0">
              <span className="text-white text-lg">✓</span>
            </div>
            <div className="flex-1 min-w-0">
