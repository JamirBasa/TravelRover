      ...
      <div className="text-center">
        ...
        <div className="brand-card p-6 sm:p-8 max-w-md mx-auto">
          ...
          <div className="relative mb-6">
            ...
            <div className="absolute inset-0 w-20 h-20 mx-auto border-4 border-blue-300 rounded-full animate-ping opacity-30 animation-delay-2000"></div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="mt-8 space-y-3">
              ...
              <div className="flex items-center justify-center gap-3 text-sm text-gray-500">
                <div className="w-2 h-2 bg-blue-500 rounded-full animate-pulse animation-delay-4000"></div>
