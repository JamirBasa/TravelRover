...
export function GeocodingLoadingOverlay({ isGeocoding, geocodingProgress }) {
  ...
  return (
    <div
      className="absolute inset-0 bg-white/90 backdrop-blur-sm z-50 
      ...
      <div className="text-center">
        ...
        <div className="relative mb-4 flex items-center justify-center">
          <div className="absolute">
            <div className="w-20 h-20 rounded-full bg-blue-100 animate-ping"></div>
          </div>
          <MapPin className="relative h-16 w-16 text-blue-600 animate-bounce z-10" />
        </div>
