  ...
  return (
    <div className="brand-card shadow-lg border-0 overflow-hidden w-full">
      <div className="grid grid-cols-1 xl:grid-cols-4 gap-0 w-full">
        ...
        >
          <div className="p-4 sm:p-6 space-y-4 sm:space-y-6 xl:sticky xl:top-20">
            ...
            <div className="brand-gradient rounded-lg p-4 text-white shadow-lg">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-white/80 text-xs">Essential details</p>
                </div>
              </div>

              <div className="space-y-3">
                <div className="flex flex-col gap-1 py-1.5 border-b border-white/20">
                ...
                {trip?.hasRealFlights && (
                  <div className="flex justify-between items-center py-1.5">
                    ...
                    <span className="font-semibold text-green-300 flex items-center gap-1 text-sm">
            ...
            <div className="bg-white rounded-lg shadow-md border border-gray-100 p-4">
              ...
              <div className="space-y-2">
                <button
                  className="brand-button w-full py-2 px-3 rounded-lg font-medium transition-all duration-300 flex items-center justify-center gap-2 hover:shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 text-sm"
                ...
                <button
                  className="w-full bg-gradient-to-r from-emerald-600 to-green-600 hover:from-emerald-700 hover:to-green-700 text-white py-2 px-3 rounded-lg font-medium transition-all duration-300 flex items-center justify-center gap-2 hover:shadow-md focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 text-sm"
                ...
                <button
                  className="w-full bg-gradient-to-r from-gray-600 to-slate-600 hover:from-gray-700 hover:to-slate-700 text-white py-2 px-3 rounded-lg font-medium transition-all duration-300 flex items-center justify-center gap-2 hover:shadow-md focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 text-sm"
            ...
            <div className="bg-gradient-to-br from-sky-50 to-blue-50 rounded-lg p-4 border border-sky-200/50 shadow-sm">
              <div className="flex items-center gap-2 mb-3">
                ...
                <div>
                  ...
                  <p className="text-sky-700 text-xs">Stay prepared</p>
                </div>
              </div>
              <p className="text-sky-800 text-xs mb-3 leading-relaxed">
                Check weather for{" "}
              ...
              <button
                className="w-full bg-sky-600 hover:bg-sky-700 text-white px-3 py-2 rounded text-xs font-medium transition-all duration-300 hover:shadow-sm focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2"
